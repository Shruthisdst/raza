...
class dataModel extends Model {
	...
	public function getChangesFromGit($repo) {
		...
		foreach ($lines as $file) {
			...
			if((preg_match('/^([AMD])\s(.*)/', $file, $matches)) && ((preg_match('/public\/Archives\/Articles/', $file)) || (preg_match('/public\/Archives\/Books/', $file)) || (preg_match('/public\/Archives\/Brochures/', $file)) || (preg_match('/public\/Archives\/Letters/', $file)) || (preg_match('/public\/Archives\/Miscellaneous/', $file)) || (preg_match('/public\/Archives\/Unsorted/', $file)) || (preg_match('/public\/Archives\/Photographs/', $file)) || (preg_match('/public\/Archives\/Artworks/', $file)))) {
