...
class dataModel extends Model {
	...
	public function getChangesFromGit($repo) {
		...
		foreach ($lines as $file) {
			...
			if((preg_match('/^([AMD])\s(.*)/', $file, $matches)) && ((preg_match('/public\/Articles/', $file)) || (preg_match('/public\/Letters/', $file)) || (preg_match('/public\/Miscellaneous/', $file)) || (preg_match('/public\/Unsorted/', $file)))) {
