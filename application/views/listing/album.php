...
<?php foreach ($data as $row) { ?>
        <div class="post">
            <a href="<?=BASE_URL?>listing/archives/<?=$row->albumID?>" title="View Details">
                <img src="<?=$viewHelper->includeRandomThumbnailFromArchive($row->id)?>">
                <div class="OverlayText"><?=$viewHelper->getPhotoCount($row->id)?><span class="link"><i class="fa fa-link"></i></span></div>
                <?php
