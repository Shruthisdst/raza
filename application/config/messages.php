...
define('FB_SUBJECT_PREFIX', '[The Raza Foundation Website Feedback] ');
...
define('REG_VERIFY_SUB', '[The Raza Foundation] Please verify your email');
...
define('REG_CONFIRM_SUB', '[The Raza Foundation] Registration confirmed');
...
define('PWD_RESET_SUB', '[The Raza Foundation] Password reset request received');
...
define('PWD_RESET_LINK_SUB', '[The Raza Foundation] Password successfully reset');
...
define('GIT_ADD_MSG', 'New Json for Albums / Archives added');
define('GIT_MOD_MSG', 'Json for Albums / Archives modifed');
define('GIT_DEL_MSG', 'Json for Albums / Archives deleted');
